...
export const router = createRouter({
  ...
  routes: [
    { path: "/", name: "home", component: HomeView },
    {
      ...
      // captured once elsewhere, is what dev.remoteHmr patches in place:
      // vue-router re-resolves this function on every navigation, so in dev
      // it always returns whatever is currently being edited. Being a
      // static route also means this path never needed the "await extension
      // discovery before installing the router" fix in main.js; it exists
      // in the route table from t=0, same as "/".
      component: () =>
